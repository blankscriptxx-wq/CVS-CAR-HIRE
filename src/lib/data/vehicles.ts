...
export const vehicles: Vehicle[] = [
  ...
  },
  {
    ...
    category: "prestige",
    bodyType: "saloon",
    heroImage: img("mercedes-e-class-hire", "studio-wide-front.jpg", "Grey Mercedes-Benz E-Class AMG Line, front three-quarter — executive car hire from CVS Car Hire"),
    thumbnail: img("mercedes-e-class-hire", "studio-elevated-front.jpg", "Grey Mercedes-Benz E-Class AMG Line, elevated front three-quarter, available to hire from CVS Car Hire"),
    gallery: [
      img("mercedes-e-class-hire", "studio-wide-front.jpg", "Mercedes-Benz E-Class AMG Line — front three-quarter, studio"),
      img("mercedes-e-class-hire", "studio-front.jpg", "Mercedes-Benz E-Class AMG Line — head-on, studio"),
      img("mercedes-e-class-hire", "studio-side.jpg", "Mercedes-Benz E-Class AMG Line — side profile, studio"),
      img("mercedes-e-class-hire", "studio-elevated-front.jpg", "Mercedes-Benz E-Class AMG Line — elevated front, studio"),
      img("mercedes-e-class-hire", "studio-rear-3q.jpg", "Mercedes-Benz E-Class AMG Line — rear three-quarter, studio"),
      img("mercedes-e-class-hire", "studio-wide-rear.jpg", "Mercedes-Benz E-Class AMG Line — rear, studio"),
      img("mercedes-e-class-hire", "studio-elevated-rear.jpg", "Mercedes-Benz E-Class AMG Line — elevated rear, studio"),
      img("mercedes-e-class-hire", "studio-wheel.jpg", "Mercedes-Benz E-Class AMG Line — wheel detail"),
      img("mercedes-e-class-hire", "studio-headlight.jpg", "Mercedes-Benz E-Class AMG Line — headlight detail"),
      img("mercedes-e-class-hire", "studio-rear-light.jpg", "Mercedes-Benz E-Class AMG Line — rear light detail"),
    ],
    shortDescription:
      "Business class on wheels — Mercedes' executive saloon, calm, spacious and effortless.",
    fullDescription:
      "The Mercedes-Benz E-Class is the executive saloon at its most polished — quiet, spacious and beautifully finished, with the composed ride and understated presence that have made it the default choice for business travel and airport runs. This AMG Line example pairs that refinement with a sharper stance and modern cabin technology. Available self-drive or with a professional chauffeur, it is equally at home on a corporate day, a smart evening out or a long motorway cruise. Prestige without the noise.",
    seats: 5,
    doors: 4,
    transmission: "automatic",
    fuelType: "petrol",
    ...
    monthlyPriceFrom: 1800,
    recommendedOccasions: ["self-drive", "corporate", "airport", "weekend"],
    relatedVehicles: ["bmw-3-series-hire", "mercedes-glc-43-amg-hire", "bmw-x5-hire"],
    knowledgeFaqs: [
      { question: "Is the Mercedes E-Class available with a chauffeur?", answer: "Yes. The E-Class can be hired self-drive or with a professional chauffeur, which makes it a popular choice for airport transfers, corporate travel and events." },
      { question: "How many seats does the Mercedes E-Class have?", answer: "The E-Class is a five-seat, four-door executive saloon with an automatic gearbox." },
      { question: "Is the E-Class a good car for airport transfers?", answer: "Yes. Its refined, quiet ride, generous rear space and large boot make the E-Class well suited to airport runs and longer business journeys." },
      { question: "What is the minimum age to hire the Mercedes E-Class?", answer: "The minimum age for self-drive hire of the E-Class is 23, subject to our standard licence and insurance checks." },
    ],
    metaTitle: "Mercedes-Benz E-Class Hire Birmingham | CVS Car Hire",
    metaDescription:
      "Hire the Mercedes-Benz E-Class in Birmingham with CVS Car Hire — self-drive or chauffeur-driven executive saloon, nationwide UK delivery. Check availability today.",
  },
  {
    id: "ferrari-roma",
  ...
  },
  {
    ...
    categories: ["prestige"],
    bodyType: "suv",
    heroImage: img("ferrari-purosangue-hire", "studio-wide-front.jpg", "Aubergine Ferrari Purosangue, front three-quarter — V12 luxury hire from CVS Car Hire"),
    thumbnail: img("ferrari-purosangue-hire", "studio-front.jpg", "Aubergine Ferrari Purosangue, head-on, available to hire from CVS Car Hire"),
    gallery: [
      img("ferrari-purosangue-hire", "studio-wide-front.jpg", "Ferrari Purosangue — front three-quarter, studio"),
      img("ferrari-purosangue-hire", "studio-front.jpg", "Ferrari Purosangue — head-on, studio"),
      img("ferrari-purosangue-hire", "studio-side.jpg", "Ferrari Purosangue — side profile, studio"),
      img("ferrari-purosangue-hire", "studio-elevated-front.jpg", "Ferrari Purosangue — elevated front, studio"),
      img("ferrari-purosangue-hire", "studio-rear-3q.jpg", "Ferrari Purosangue — rear three-quarter, studio"),
      img("ferrari-purosangue-hire", "studio-wide-rear.jpg", "Ferrari Purosangue — rear, studio"),
      img("ferrari-purosangue-hire", "studio-elevated-rear.jpg", "Ferrari Purosangue — elevated rear, studio"),
      img("ferrari-purosangue-hire", "studio-wheel.jpg", "Ferrari Purosangue — wheel detail"),
      img("ferrari-purosangue-hire", "studio-headlight.jpg", "Ferrari Purosangue — headlight detail"),
      img("ferrari-purosangue-hire", "studio-rear-light.jpg", "Ferrari Purosangue — rear light detail"),
    ],
    shortDescription:
  ...
  },
  {
    ...
    bodyType: "saloon",
    heroImage: img("rolls-royce-phantom-hire", "studio-wide-front.jpg", "Navy Rolls-Royce Phantom VIII, front three-quarter — luxury chauffeur hire from CVS Car Hire"),
    thumbnail: img("rolls-royce-phantom-hire", "studio-side.jpg", "Navy Rolls-Royce Phantom VIII, side profile, available to hire from CVS Car Hire"),
    gallery: [
      img("rolls-royce-phantom-hire", "studio-wide-front.jpg", "Rolls-Royce Phantom — front three-quarter, studio"),
      img("rolls-royce-phantom-hire", "studio-front.jpg", "Rolls-Royce Phantom — head-on, studio"),
      img("rolls-royce-phantom-hire", "studio-side.jpg", "Rolls-Royce Phantom — side profile, studio"),
      img("rolls-royce-phantom-hire", "studio-elevated-front.jpg", "Rolls-Royce Phantom — elevated front, studio"),
      img("rolls-royce-phantom-hire", "studio-rear-3q.jpg", "Rolls-Royce Phantom — rear three-quarter, studio"),
      img("rolls-royce-phantom-hire", "studio-wide-rear.jpg", "Rolls-Royce Phantom — rear, studio"),
      img("rolls-royce-phantom-hire", "studio-elevated-rear.jpg", "Rolls-Royce Phantom — elevated rear, studio"),
      img("rolls-royce-phantom-hire", "studio-wheel.jpg", "Rolls-Royce Phantom — wheel detail"),
      img("rolls-royce-phantom-hire", "studio-headlight.jpg", "Rolls-Royce Phantom — headlight detail"),
      img("rolls-royce-phantom-hire", "studio-rear-light.jpg", "Rolls-Royce Phantom — rear light detail"),
    ],
    shortDescription:
  ...
  },
  {
    ...
    bodyType: "coupe",
    heroImage: img("porsche-911-gt3-rs-hire", "studio-wide-front.jpg", "White Porsche 911 GT3 RS, front three-quarter — track-bred supercar hire from CVS Car Hire"),
    thumbnail: img("porsche-911-gt3-rs-hire", "studio-rear-3q.jpg", "White Porsche 911 GT3 RS with its swan-neck wing, rear three-quarter, available to hire from CVS Car Hire"),
    gallery: [
      img("porsche-911-gt3-rs-hire", "studio-wide-front.jpg", "Porsche 911 GT3 RS — front three-quarter, studio"),
      img("porsche-911-gt3-rs-hire", "studio-front.jpg", "Porsche 911 GT3 RS — head-on, studio"),
      img("porsche-911-gt3-rs-hire", "studio-side.jpg", "Porsche 911 GT3 RS — side profile, studio"),
      img("porsche-911-gt3-rs-hire", "studio-elevated-front.jpg", "Porsche 911 GT3 RS — elevated front, studio"),
      img("porsche-911-gt3-rs-hire", "studio-rear-3q.jpg", "Porsche 911 GT3 RS — rear three-quarter, studio"),
      img("porsche-911-gt3-rs-hire", "studio-wide-rear.jpg", "Porsche 911 GT3 RS — rear, studio"),
      img("porsche-911-gt3-rs-hire", "studio-elevated-rear.jpg", "Porsche 911 GT3 RS — elevated rear, studio"),
      img("porsche-911-gt3-rs-hire", "studio-wheel.jpg", "Porsche 911 GT3 RS — centre-lock wheel detail"),
      img("porsche-911-gt3-rs-hire", "studio-headlight.jpg", "Porsche 911 GT3 RS — headlight detail"),
      img("porsche-911-gt3-rs-hire", "studio-rear-light.jpg", "Porsche 911 GT3 RS — rear light detail"),
    ],
    shortDescription:
  ...
  },
  {
    ...
    category: "luxury-4x4",
    bodyType: "suv",
    heroImage: img("land-rover-defender-hire", "studio-wide-front.jpg", "White Land Rover Defender, front three-quarter — luxury 4x4 hire from CVS Car Hire"),
    thumbnail: img("land-rover-defender-hire", "studio-front.jpg", "White Land Rover Defender, head-on, available to hire from CVS Car Hire"),
    gallery: [
      img("land-rover-defender-hire", "studio-wide-front.jpg", "Land Rover Defender — front three-quarter, studio"),
      img("land-rover-defender-hire", "studio-front.jpg", "Land Rover Defender — head-on, studio"),
      img("land-rover-defender-hire", "studio-side.jpg", "Land Rover Defender — side profile, studio"),
      img("land-rover-defender-hire", "studio-elevated-front.jpg", "Land Rover Defender — elevated front, studio"),
      img("land-rover-defender-hire", "studio-rear-3q.jpg", "Land Rover Defender — rear three-quarter, studio"),
      img("land-rover-defender-hire", "studio-wide-rear.jpg", "Land Rover Defender — rear, studio"),
      img("land-rover-defender-hire", "studio-elevated-rear.jpg", "Land Rover Defender — elevated rear, studio"),
      img("land-rover-defender-hire", "studio-wheel.jpg", "Land Rover Defender — wheel detail"),
      img("land-rover-defender-hire", "studio-headlight.jpg", "Land Rover Defender — headlight detail"),
      img("land-rover-defender-hire", "studio-rear-light.jpg", "Land Rover Defender — rear light detail"),
    ],
    shortDescription:
  ...
  },
  {
    ...
    categories: ["prestige"],
    bodyType: "coupe",
    heroImage: img("ferrari-12cilindri-hire", "studio-wide-front.jpg", "Red Ferrari 12Cilindri, front three-quarter — V12 grand tourer, joining CVS Car Hire soon"),
    thumbnail: img("ferrari-12cilindri-hire", "studio-rear-3q.jpg", "Red Ferrari 12Cilindri, rear three-quarter, joining CVS Car Hire soon"),
    gallery: [
      img("ferrari-12cilindri-hire", "studio-wide-front.jpg", "Ferrari 12Cilindri — front three-quarter, studio"),
      img("ferrari-12cilindri-hire", "studio-front.jpg", "Ferrari 12Cilindri — head-on, studio"),
      img("ferrari-12cilindri-hire", "studio-side.jpg", "Ferrari 12Cilindri — side profile, studio"),
      img("ferrari-12cilindri-hire", "studio-elevated-front.jpg", "Ferrari 12Cilindri — elevated front, studio"),
      img("ferrari-12cilindri-hire", "studio-rear-3q.jpg", "Ferrari 12Cilindri — rear three-quarter, studio"),
      img("ferrari-12cilindri-hire", "studio-wide-rear.jpg", "Ferrari 12Cilindri — rear, studio"),
      img("ferrari-12cilindri-hire", "studio-elevated-rear.jpg", "Ferrari 12Cilindri — elevated rear, studio"),
      img("ferrari-12cilindri-hire", "studio-wheel.jpg", "Ferrari 12Cilindri — wheel detail"),
      img("ferrari-12cilindri-hire", "studio-headlight.jpg", "Ferrari 12Cilindri — headlight detail"),
      img("ferrari-12cilindri-hire", "studio-rear-light.jpg", "Ferrari 12Cilindri — rear light detail"),
    ],
    shortDescription:
