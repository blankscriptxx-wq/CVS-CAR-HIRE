...
export const locations: LocationContent[] = [
  {
    ...
    recommendedVehicles: ["lamborghini-revuelto-hire", "rolls-royce-cullinan-hire", "mercedes-amg-g63-hire", "lamborghini-urus-performante-hire", "ferrari-sf90-hire", "porsche-911-gt3-rs-hire"],
    ...
    faqs: [
      ...
      { question: "Can I hire a supercar in Birmingham?", answer: "Yes. Supercar hire is our speciality in Birmingham — Lamborghini, Ferrari, the Audi R8 and more, offered self-drive from our Birmingham base with delivery across the city and West Midlands. Tell us your dates and the car you have in mind and we'll confirm availability." },
      { question: "Is there self-drive supercar hire in Birmingham?", answer: "Yes — most of our supercars are available self-drive in Birmingham, so the day is entirely yours. Minimum age, licence and deposit requirements vary by car and are confirmed on enquiry." },
      { question: "How much is supercar or luxury car hire in Birmingham?", answer: "Prices depend on the car, the duration and the mileage you need, with daily, weekend and longer rates available. Message us with the vehicle and your dates and we'll confirm an exact price — there are no hidden surprises." },
      { question: "Can I hire a supercar for one day in Birmingham?", answer: "Yes — single-day hire is available on most of our fleet in Birmingham, as well as weekend and longer arrangements. Tell us your date and we'll confirm availability and the rate." },
